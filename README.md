...
de caronas solidárias, projetado para atender às necessidades da
...
Todo o estado do sistema (usuários,
...
⦁	Fluxo de Negociação de Carona:
Em vez de um simples "aceitar/recusar", o sistema permite que o motorista faça
uma contraproposta de locais de embarque e desembarque, que o passageiro pode 
então aceitar ou recusar, tornando o processo de solicitação mais flexível e realista.
